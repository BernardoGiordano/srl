 ...
 * journey itself is `support/journey/journey.mjs` and is written once. What this file
 * adds is the staging, the loop, and the refusal to let an engine quietly not run. An
 * engine declared in `ENGINES` and skipped here would turn the support matrix back into
 * a list of names, which is the state ADR-0116 exists to leave.
 *
