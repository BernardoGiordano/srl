...
export interface AppManifest {
   ...
   * startup so no component costs a request of its own. Generated by
   * tools/delivery/bundle-templates.mjs; absent in development, where templates are
   * fetched individually and reloaded on change.
   */
