...
| [ADR-0119](0119-a-source-consumer-type-checks-against-the-declarations.md) | A source consumer type-checks against the declarations | accepted | `source/tsconfig.base.json`, `source/tsconfig.source.json`, `tsconfig.json`, `cli/package/interface.mjs`, `tools/delivery/package-bundle.mjs`, `tools/checks/verify-deps.mjs`, `tools/checks/pack-check.mjs` |
